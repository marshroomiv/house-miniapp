...
Page({
    ...
    onLoad: function(options) {
        ...
        publicHouseFinder.getAllSellHouseObjectCopy(app.services.constantService.CACHE_READ_WRITE)
            .subscribe((res)=>{
                if(res.data != null && res.data.list != null){
    ...
    onSearch: function(e){
        ...
        publicHouseFinder.getSellHouseObjectsByCommunityName(this.data.searchVal.trim(),app.services.constantService.CACHE_READ_WRITE)
            .subscribe((res)=>{
                if(res.data != null && res.data.list != null){
                    this.setData({'houseObjects':res.data.list})
                }else{
    ...
    onMenuEvent: function (e) {
        if(e.detail.action=='SORT'){
            ...
            publicHouseFinder.searchSellHouseObject(searchHouseRequest, app.services.constantService.CACHE_READ_WRITE)
                .subscribe((res)=>{
                    if(res.data != null){
                        this.setData({'houseObjects':res.data.list})
                    }
