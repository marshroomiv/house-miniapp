...
Page({
        ...
        publicHouseFinder.getHouseObjectCopyByPK(options.houseUid, app.services.constantService.CACHE_READ_WRITE)
            .subscribe((res) => {
                if (res.data != null && res.data.value != null) {
                    ...
                    if(res.data.value.sellIndicator!='Y'){
                        return
                    }
                    ...
                    if(res.data.value.communityUid!=null){
                        publicHouseFinder.getSellHouseCountByCommunityUid(res.data.value.communityUid, app.services.constantService.CACHE_READ_WRITE)
                            .subscribe((res)=>{
                                if(res.data != null && res.data.value != null){
                                    this.setData({'sellHouseCount':res.data.value })
                                }
                            })
                    }

                    publicHouseFinder.searchSellHouseObjectByUnitPrice(res.data.value.unitPrice, app.services.constantService.CACHE_READ_WRITE)
                        .subscribe((res)=>{
                            if(res.data != null && res.data.list != null){
    ...
    calculatorTap: function(e){
        wx.navigateTo({
            url: app.services.utilService.joinUrl('/pages/calculator/calculator?totalAmount=' + this.data.houseObject.price)
        })
    },
    ...
    onShareAppMessage: function (res) {
        return commonService.onShareSellHouse(this.data.houseObject.houseUid, this.data.houseObject.houseTitle)
    },
